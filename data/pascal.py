...
class DatasetPASCAL(Dataset):
    def __init__(self, datapath, fold, transform, split, shot, use_original_imgsize):
        ...
        self.img_path = os.path.join(datapath, 'VOC2012/VOC2012/JPEGImages/')
        self.ann_path = os.path.join(datapath, 'VOC2012/VOC2012/SegmentationClassAug/')
    ...
    def apply_tf_se(self, img):
        ...
        img = np.asarray(img)  # (H,W,3)    #[192,256,3]
    ...
    def __getitem__(self, idx):
        ...
        query_img = self.transform(query_img)   #[3,512,512]
        ...
        #query_mask[512,512],query_ignore_idx[512,512]
        ...
        support_masks = torch.stack(support_masks)  #[1,512,512]
        support_ignore_idxs = torch.stack(support_ignore_idxs)  #[1,512,512]
