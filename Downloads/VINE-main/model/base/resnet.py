...
def resnet50(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    if pretrained:
        ...
        # /mnt/disk2/liuhongli/data_fcp/resnet50_v2.pth
        # model_path = '../resnet50_v2.pth'
        model_path = '/mnt/disk18/liuhongli/FCP_v2/resnet50_v2.pth'
        # model_path = '/mnt/disk2/liuhongli/data_fcp/resnet50_v2.pth'
...
def resnet101(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    if pretrained:
        # model.load_state_dict(model_zoo.load_url(model_urls['resnet50']))
        model_path = '/mnt/disk18/liuhongli/FCP_v2/resnet101_v2.pth'
        model.load_state_dict(torch.load(model_path), strict=False)
    return model
